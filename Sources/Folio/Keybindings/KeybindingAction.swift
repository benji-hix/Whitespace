...
enum KeybindingAction: String, CaseIterable, Codable {
    ...
    static var defaults: [KeybindingAction: ShortcutBinding] {
        ...
        return [
            ...
            .killLine:           ShortcutBinding(keyCode: 40,  modifiers: ctrl),  // ⌃K
            .deleteCharForward:  ShortcutBinding(keyCode: 2,   modifiers: ctrl),  // ⌃D
        ]
    }
}
